...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_img_name', type=str, default='pp_174_tumor_Nr56_x4_StitchPag_stitch_2563x4381x2162', help="base image name")
    ...
    if opt.test:
        ...
        H,W = train_dataset.get_H_W()
        trainer.test(-1, 1, (end_slice-start_slice+1)*2, H, W, batch_size=1000)
